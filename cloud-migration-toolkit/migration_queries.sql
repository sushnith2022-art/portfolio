    ...
    -- Description: Enterprise migration patterns applied during 
    --              large-scale data warehouse migration at CVS Health
    --              Covers schema conversion, CDC, validation and star schema design
    -- ============================================
